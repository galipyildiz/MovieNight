...
namespace _35.MovieNight.Models
{
    public static class DbSeed
    {
        public static void SeedRolesAndUsers()
        {
            using (var context = new ApplicationDbContext())
            {
                if (!context.Roles.Any(x => x.Name == "admin"))
                {
                    ...
                    roleManager.Create(new IdentityRole("admin"));//role olusturma
                }
                if (!context.Users.Any(x => x.UserName == "admin@kod.fun"))
                {
                    ...
                    userManager.AddToRole(adminUser.Id, "admin");//role atama
                }
            }
        }
        public async static Task SeedMovies()
        {
            ...
            using (var db = new ApplicationDbContext())//using var db = new applicationdbcontext() 8.0 destekliyor. Biz 7.3
            using (var client = new HttpClient())
            {
                ...
                //http://www.omdbapi.com/?i=tt3896198&apikey=ab1d39b5
                ...
                foreach (string imdbId in ImdbMovieIds())
                {
                    ...
                    {
                        //install-package Microsoft.AspNet.WebApi.Client bunu yükledik apileri kullanabilmek için.
